	...
	<div class="blogin">
		...
		<ng-infocard title="登录工具" v-loading="loginState_n == -1" update="">
			...
			<div v-if="loginState_n == 1">
				<el-button type="success" @click="open('切换账号', ReLogin)"
					>切换账号</el-button
				>
			</div>
					...
					<div class="qrcode-con">
						...
						<div class="qrcode-box">
							...
							<img
								width="140"
								height="140"
								style="background-color: #fff; border: 1px solid #cdd0d9"
								:src="traceSrc"
							/>
...
export default {
	...
	methods: {
		open(active, fun) {
			this.$confirm(
				"您当前已经登录了，重新登录可能中断正在运行的任务，还需要继续吗？",
				active,
				{
...
.qrcode-login .qrcode-con .qrcode-box .qrcode-tips {
	...
	left: 50%;
	margin-left: -240px;
	background: url(//s1.hdslb.com/bfs/static/passport/static/img/qr-tip.20e4055.png)
		no-repeat;
