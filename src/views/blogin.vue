    ...
    <div class="blogin">
        ...
        <ng-infocard title="登录工具" v-loading="loginState_n == -1" update="">
            <div class="loginta">
                ...
                <div> 当前登录状态：<em>{{ loginState_t }}</em></div>
            </div>
                ...
                <div class="qrcode-login">
                    <div class="qrcode-con">
                        ...
                        <div class="qrcode-box">
                            ...
                            <img width="140" height="140" style="background-color: #fff; border: 1px solid #cdd0d9;"
                                :src="traceSrc" />
                    ...
                    <div class="qrcode-footer">
                        <p class="status-txt">{{ is_effect ? "扫描二维码登录":"二维码已失效"}} </p>
                        <p class="app-link">请使用 <a href="//app.bilibili.com/"
                                target="_blank">哔哩哔哩客户端</a><br>扫码登录<br>或扫码下载APP</p>
                    </div>
                </div>
            </div>
        </ng-infocard>
