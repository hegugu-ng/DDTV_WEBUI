  ...
  <div class="setting">
    <ng-infocard title="自动转码总开关" update="">
      <p class="info-text-box info-text-war">
        ...
        <br />该功能需要依赖 <a class="keyword2" href="http://ffmpeg.org/">ffmpeg</a> ，请根据
        <a href="https://ddtv.pro/AdvancedFeatures/%E8%87%AA%E5%8A%A8%E8%BD%AC%E7%A0%81.html" class="keyword2"
          >进阶功能说明-自动转码</a
        >
        页面当中的内容进行检查是否已经安装ffmpeg。
      ...
      <el-switch
        ...
        size="large"
        active-text="开启视频转码"
        inactive-text="关闭视频转码"
        v-model="liverecode"
        active-color="#46d485"
        inactive-color="#efe3e3"
        :before-change="beforeChangeRecode"
      ></el-switch>
    </ng-infocard>
    ...
    <ng-infocard title="弹幕录制总共开关(包括礼物、舰队、SC)" update="" style="margin-top: 10px">
      ...
      <el-switch
        ...
        size="large"
        active-text="开启弹幕录制"
        inactive-text="关闭弹幕录制"
        v-model="livedamaku"
        active-color="#46d485"
        inactive-color="#efe3e3"
        :before-change="beforeChangeDanmuk"
      ></el-switch>
    </ng-infocard>
    ...
    <ng-infocard title="文件自动分片" update="" style="margin-top: 10px">
      <p class="info-text-box info-text-war">
        ...
        <br />修改后需要点击后面的的“提交”按钮。 <br />如设置小于100MB可能出现错误，推荐大于100MB。
      </p>
      <el-switch
        class="live-switch"
        size="large"
        active-text="开启文件分片"
        inactive-text="关闭文件分片"
        v-model="liverecelip"
        active-color="#46d485"
        inactive-color="#efe3e3"
      ></el-switch>
    ...
    <ng-infocard title="B站登录设置" update="" style="margin-top: 10px">
      <p class="info-text-box info-text-war">DDTV的一些功能依赖于B站账号，故需要登录B站账号才能使用。</p>
      ...
      for (let item of data) {
        switch (item.Key) {
          case 21:
            ...
            break;
          case 7:
            this.liverecode = item.Value === "True";

            break;
          case 16:
            this.livedamaku = item.Value === "True";
            break;
        }
      }
    },
