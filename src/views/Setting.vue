	...
	<div class="setting">
		<ng-infocard title="自动转码总开关" update="">
			<p class="info-text-box info-text-war">
				...
				<br />该功能需要依赖
				<a class="keyword2" href="http://ffmpeg.org/">ffmpeg</a> ，请根据
				<a
		...
		<ng-infocard title="文件自动分片" update="" style="margin-top: 10px">
			...
			<el-button style="margin-left: 10px" type="primary" @click="SetCutVdio"
				>提交</el-button
			>
		</ng-infocard>
		...
		<ng-infocard title="B站登录设置" update="" style="margin-top: 10px">
			...
			<el-button type="success" @click="$router.push('/blogin')"
				>前往登录管理</el-button
			>
		</ng-infocard>
	</div>
